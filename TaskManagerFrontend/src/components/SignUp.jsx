    ...
    return (
        <div className='max-w-md w-full bg-white shadow-lg border border-purple-100 rounded-xl p-8'>
            <div className="mb-6 text-center">
                <div className="w-16 h-16 bg-gradient-to-br from-blue-400 to-purple-400 rounded-full mx-auto flex items-center justify-center mb-4">
            ...
            <form onSubmit={handleSubmit} className='space-y-4'>
                ...
                <button type='submit' className={BUTTONCLASSES} disabled={loading}>{loading ? "Signing Up..." : <><FaUserPlus className='w-4 h-4' />Sign Up</>}</button>
            </form>
